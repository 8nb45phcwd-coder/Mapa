...
- When a 110m polyline diverges more than ~10% in length from its 50m counterpart or is missing entirely, the engine reuses the hi-res coordinates as the low-res fallback to keep coverage deterministic and lengths stable.
